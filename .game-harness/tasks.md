...
This checklist is not the issue source of truth. Use Linear for issue ownership and Beads for local execution dependencies.
...
- [x] Create Korean-first intake text surface table with English consequence parity.
