...
function buildCleanCoverProof(): SameOrderAgenticRouteProof {
  ...
  return routeProof({
    ...
    socialReactionSummary: "The clerk closes a normal receipt; no other actor needs to escalate the record.",
  });
}
...
function validateCleanCover(
  ...
  if (proof.finalObjectStates.receipt_tray !== "normal" || proof.economyAfter.recordBurden !== 0 || proof.stationCitation !== undefined) {
