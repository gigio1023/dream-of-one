...
function buildBeats(): SameOrderStoryletRuntimeBeat[] {
  return [
    ...
    },
    {
      ...
      requiredVisibleObjects: ["receipt_tray", "correction_slip", "report_tray"],
      actionStepIds: [
      ...
      ledgerEventKinds: ["correction_offered", "store_sale_corrected", "store_exception_reported"],
      affordances: ["offer_correction", "attach_correction", "place_note"],
      evidenceEvents: ["dialogue_choice_selected", "npc_suspicion_changed", "response_hesitation_noted", "free_input_submitted"],
      providerPurpose: "npc_reaction_line",
      runtimeProof: "The probe maps repair and mismatch to correction or Store note actions with deterministic ledger events.",
    },
    {
      ...
      requiredVisibleObjects: ["store_queue_mark", "report_tray", "park_notice_board", "civic_ledger"],
      actionStepIds: [
      ...
      ledgerEventKinds: ["queue_delay_noted", "public_rumor_posted", "store_exception_reported", "store_report_escalated"],
      affordances: ["complain_delay", "post_rumor", "place_note", "forward_report"],
    ...
    },
    {
      ...
      requiredVisibleObjects: ["station_dossier", "civic_ledger"],
      actionStepIds: ["inquest.station.cite_store_report"],
      providerJobIds: ["inquest_opened.inquest.station.cite_store_report.provider-action-proposal"],
      ledgerEventKinds: ["station_record_cited"],
      affordances: ["cite_record"],
      evidenceEvents: ["station_inquest_opened", "verdict_reached"],
      providerPurpose: "station_intake_line",
      runtimeProof: "The Station beat maps to one accepted cite-record action against an exact forwarded Store ledger event.",
    },
  ];
}
