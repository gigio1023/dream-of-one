  ...
  return [
    {
      ...
      ledgerEventKinds: ["usual_order_cited", "store_sale_normal", "queue_routine_kept", "public_routine_vouched", "local_tip_shared", "store_receipt_marked"],
      affordances: ["cite_expected_order", "create_receipt", "accept_routine", "vouch_routine", "share_local_tip", "mark_receipt"],
