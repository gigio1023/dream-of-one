  ...
  return [
    {
      ...
      providerJobIds: [
        ...
        "clean_cover.clean.waiting_customer.share_local_tip.provider-action-proposal",
        "clean_cover.clean.studio_pm.invite_review.provider-action-proposal",
      ...
      ledgerEventKinds: ["usual_order_cited", "store_sale_normal", "queue_routine_kept", "public_routine_vouched", "local_tip_shared", "studio_review_invited", "store_receipt_marked"],
      affordances: ["cite_expected_order", "create_receipt", "accept_routine", "vouch_routine", "share_local_tip", "invite_review", "mark_receipt"],
    ...
    },
    {
      ...
      requiredVisibleObjects: ["store_queue_mark", "receipt_tray", "correction_slip", "report_tray", "park_notice_board", "studio_review_queue"],
      actionStepIds: [
      ...
      providerJobIds: [
        ...
        "repair_recovered.repair.studio_pm.offer_conditional_review.provider-action-proposal",
      ...
      ledgerEventKinds: ["correction_offered", "store_sale_corrected", "queue_repair_accepted", "public_repair_noted", "studio_review_conditioned", "store_exception_reported"],
      affordances: ["offer_correction", "attach_correction", "accept_repair", "post_repair_notice", "offer_conditional_review", "place_note"],
