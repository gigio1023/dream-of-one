...
function buildBeats(): SameOrderStoryletRuntimeBeat[] {
  return [
    ...
    },
    {
      ...
      ledgerEventKinds: ["queue_delay_noted", "public_rumor_posted", "store_exception_reported", "service_paused", "store_report_escalated"],
      affordances: ["complain_delay", "post_rumor", "place_note", "pause_service", "forward_report"],
