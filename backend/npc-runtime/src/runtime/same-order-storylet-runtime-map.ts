...
function buildBeats(): SameOrderStoryletRuntimeBeat[] {
  return [
    ...
    },
    {
      ...
      requiredVisibleObjects: ["store_queue_mark", "receipt_tray", "correction_slip", "report_tray"],
      actionStepIds: [
      ...
      ledgerEventKinds: ["correction_offered", "store_sale_corrected", "queue_repair_accepted", "store_exception_reported"],
      affordances: ["offer_correction", "attach_correction", "accept_repair", "place_note"],
