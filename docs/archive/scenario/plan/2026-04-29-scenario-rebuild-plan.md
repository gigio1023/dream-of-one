...
**Architecture:** Scenario canon lives under `docs/scenario/`. Existing `docs/design/` remains product-level design. `docs/runtime/godot/` remains migration-only and must not become the scenario bible.
...
- [x] **Project links:** Link scenario docs from `README.md`, `docs/README.md`, and product design docs.
- [x] **Pitch-ready expansion:** Add `docs/archive/scenario/pitch/` with product thesis, AI gameplay architecture, vertical slice plan, team plan, funding plan, and risk register.
...
The scenario plan must support team formation and funding discussion. Use `docs/archive/scenario/pitch/` for:
