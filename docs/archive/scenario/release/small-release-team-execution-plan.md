...
| Purpose | Document |
|---|---|
| Release definition | `docs/archive/scenario/release/small-release-definition.md` |
| Current readiness verdict | `docs/archive/scenario/release/small-release-readiness-report.md` |
| Small-release game design pack | `docs/archive/scenario/release/game-design/README.md` |
| Scenario authoring method | `docs/archive/scenario/release/game-design/00-authoring-method.md` |
| Beat-to-runtime matrix | `docs/archive/scenario/release/game-design/02-beat-to-runtime-matrix.md` |
| Codex NPC interaction contract | `docs/archive/scenario/release/game-design/03-codex-npc-interaction-contract.md` |
| Level and environment design | `docs/archive/scenario/release/game-design/04-level-and-environment-design.md` |
| Onboarding/localization/accessibility | `docs/archive/scenario/release/game-design/05-onboarding-localization-accessibility.md` |
| Polish and release quality bar | `docs/archive/scenario/release/game-design/06-polish-release-quality-bar.md` |
| Scenario canon | `docs/scenario/README.md` |
| Codex gameplay architecture | `docs/archive/scenario/pitch/02-ai-gameplay-architecture.md` |
| Codex CLI worker contract | `docs/archive/scenario/pitch/07-codex-cli-npc-runtime.md` |
| Vertical slice scope | `docs/archive/scenario/pitch/03-vertical-slice-plan.md` |
| Scenario quality bar | `docs/scenario/bible/11-quality-bar-and-validation.md` |

Do not use `docs/runtime/godot/` as scenario canon. Use it only for migration/runtime gate references.
...
- Do-not list.
- If the task touches gameplay, scenario, UI text, AI NPC behavior, or 3D hub layout: a mapped requirement from `docs/archive/scenario/release/game-design/`.
...
| Release docs | `docs/archive/scenario/release/*.md` |
...
- Modify docs under `docs/archive/scenario/release/`
...
- Add: `docs/archive/scenario/release/player-quickstart.md`
- Modify: `docs/archive/scenario/release/small-release-definition.md`
- Modify: `docs/archive/scenario/release/small-release-readiness-report.md`
...
- Add: `docs/archive/scenario/release/qa-playtest-protocol.md`
