# Godot Runtime Parity Matrix

| Behavior | Godot/Backend Evidence | Status |
|---|---|---|
...
| Station intake rejects SA_BREAK | runtime slice Evidence Pack | complete |
| Full report-intake-inquest-verdict loop | future domain controller issue | pending |
| Multi-run trajectory diversity | future Evidence issue | pending |
