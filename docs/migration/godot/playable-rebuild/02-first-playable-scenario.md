...
This file is retained as migration-era playable-loop implementation notes. Active scenario canon lives in `docs/scenario/`, especially `docs/scenario/bible/05-episode-station-soft-inquest.md` and `docs/scenario/bible/06-cover-tests-and-evidence.md`.
...
The slice is playable when a fresh user can launch the project and, without reading docs, understand where they are, what can be interacted with, what the four speech options mean, why Exposure changed, and whether they defused or escalated the session.
