...
Build the first playable Godot 4.x 3D social-stealth vertical slice on top of the current migration shell.
...
- Modify: `docs/migration/godot/validation-gates.md`
...
- Modify: `README.md`
- Modify: `plan.md`
- Modify: `docs/migration/godot/README.md`
- Modify: `docs/migration/godot/validation-gates.md`
...
```bash
rg -n "playable|Playable|playable_slice_smoke|SocialStealthHud" README.md plan.md docs/migration/godot godot
```
