...
This directory is the executor-facing plan for turning the current Godot migration shell into a playable 3D social-stealth vertical slice.
...
- `02-first-playable-scenario.md`: migration-era playable loop notes. Active scenario canon lives in `docs/scenario/bible/05-episode-station-soft-inquest.md`.
