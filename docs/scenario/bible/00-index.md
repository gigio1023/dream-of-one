...
| `05-episode-station-soft-inquest.md` | Full first playable episode arc. |
| `06-cover-tests-and-evidence.md` | Cover Tests, detector triggers, speech outcomes, artifacts, why-lines. |
