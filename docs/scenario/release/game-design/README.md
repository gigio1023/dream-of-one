...
Use `docs/scenario/release/small-release-team-execution-plan.md` for staffing and implementation order. Use this pack to decide what the team is actually building.
