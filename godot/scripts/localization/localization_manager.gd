...
const MESSAGES := {
	"ko": {
		...
		"npc.reaction.noted": "후속 메모",
		"npc.reaction.paused": "응대 중단",
		"npc.reaction.forwarded": "보고 전달",
		"npc.reaction.invited": "리뷰 열림",
		"npc.reaction.conditional": "조건부 리뷰",
		"npc.reaction.deferred": "리뷰 보류",
		"npc.reaction.blocked": "리뷰 차단",
		"npc.reaction.vouched": "공개 확인",
		"npc.reaction.repaired": "수습 게시",
		"npc.reaction.warned": "공개 경고",
		"npc.reaction.rumored": "소문 게시",
		"npc.reaction.helped": "도움",
		"npc.reaction.repair_accepted": "수습 수락",
		"npc.reaction.distanced": "거리두기",
		"npc.reaction.left": "줄 이탈",
		"npc.reaction.refused": "접촉 거부",
		"npc.reaction.delayed": "대기 지연",
	...
	"en": {
		...
		"npc.reaction.noted": "note added",
		"npc.reaction.paused": "service paused",
		"npc.reaction.forwarded": "report forwarded",
		"npc.reaction.invited": "review open",
		"npc.reaction.conditional": "conditional review",
		"npc.reaction.deferred": "review deferred",
		"npc.reaction.blocked": "review blocked",
		"npc.reaction.vouched": "public vouch",
		"npc.reaction.repaired": "repair posted",
		"npc.reaction.warned": "warning posted",
		"npc.reaction.rumored": "rumor posted",
		"npc.reaction.helped": "helped",
		"npc.reaction.repair_accepted": "repair accepted",
		"npc.reaction.distanced": "keeping distance",
		"npc.reaction.left": "left queue",
		"npc.reaction.refused": "refused contact",
		"npc.reaction.delayed": "queue delayed",
