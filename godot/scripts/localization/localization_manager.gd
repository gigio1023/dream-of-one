...
const MESSAGES := {
	"ko": {
		...
		"hud.evidence": "증거",
		"hud.choices": "1/2/3 대화 선택지   4 기록되는 자유 발화",
		"state.open": "열림",
		"state.closed": "닫힘",
		"stage.ambient": "대기",
		"stage.report": "보고",
		...
		"objective.read_rule": "상점 카운터에서 점원과 대화하세요. 말이 위험 표면입니다.",
	...
	"en": {
		...
		"hud.choices": "1/2/3 dialogue choices   4 recorded free line",
		"state.open": "open",
		"state.closed": "closed",
		...
		"objective.read_rule": "Talk to the Store Clerk. Speech is the danger surface.",
