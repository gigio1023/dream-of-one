...
const MESSAGES := {
	"ko": {
		...
		"hud.evidence": "증거",
		"hud.choices": "1 절차대로 답하기   2 절차 묻기   3 맥락 맞추기   4 커버 깨기",
		"state.open": "열림",
		"state.closed": "닫힘",
		"stage.ambient": "대기",
		"stage.report": "보고",
		"stage.intake": "접수",
		"stage.verdict": "판정",
		"objective.verdict": "판정 준비 완료. why-line 증거를 확인하고 다른 커버 경로를 다시 시험하세요.",
		"objective.inquest": "심문이 열렸습니다. 스테이션에서는 절차형 답변만 사용하세요.",
		"objective.intake": "스테이션 접수가 열렸습니다. 보고 데스크를 찾고 답변의 일관성을 유지하세요.",
		"objective.read_rule": "월드 안의 규칙 표면을 읽으세요. 텍스트가 위험 표면입니다.",
		"objective.enter_cover_test": "커버 테스트 구역에 들어가 제한된 발화 행동을 선택하세요.",
		"prompt.default": "WASD로 이동. 방향키로 시점 전환. 규칙 게시판이나 커버 테스트 구역에 접근하세요.",
		...
		"notice.opening.body": "규칙 표면을 읽으세요. 그다음 커버 테스트 구역에 들어가 답변을 절차적으로 유지하세요.",
		...
		"event.session_started": "스테이션 근처에서 세션이 시작되었습니다. 규칙 표면을 읽고 커버 테스트에 절차적으로 답하세요.",
		...
		"text_surface.TS_Store_QueueRules.body": "대기 절차: 표시된 위치에서 기다리고, 물품 수를 말한 뒤, 라벨을 소리 내어 확인하세요.",
		...
		"text_surface.TS_Station_IntakeRules.body": "스테이션 접수: 절차 질문에만 답하고 보고를 내부적으로 일관되게 유지하세요.",
	...
	"en": {
		...
		"hud.choices": "1 Comply   2 Inquire   3 Frame   4 Break",
		"state.open": "open",
		"state.closed": "closed",
		...
		"objective.verdict": "Verdict ready. Review the why-line Evidence and restart to test another cover route.",
		...
		"objective.read_rule": "Read an in-world rule surface. Text is the danger surface.",
		"objective.enter_cover_test": "Enter a Cover Test zone and choose a bounded speech act.",
		"prompt.default": "Move with WASD. Use arrow keys to look. Approach a rule board or Cover Test zone.",
		...
		"notice.opening.body": "Read a rule surface. Then enter a Cover Test zone and keep the answer procedural.",
		...
		"event.session_started": "Session started near Station. Read a rule surface, then answer a Cover Test procedurally.",
		...
		"text_surface.TS_Store_QueueRules.body": "Queue procedure: wait at the mark, state item count, confirm the label aloud.",
		...
		"text_surface.TS_Station_IntakeRules.body": "Station intake: answer only procedural questions and keep reports internally consistent.",
